<form method="post" action="condition/insertemployedYES.php">
...
<table class="col-md-12 table table-hover">
  ...
  <tbody>
    ...
    <div class="col">
    <button class="btn btn-info w-50 btn-lg" style="padding: 10px;" data-target="#carouselExampleIndicators" data-slide-to="1">Next</button>
    </div>
    </div>
    </div>
...
<fieldset class="form-group mb-5">
  ...
  <div class="row text-center">
    ...
    <div class="carousel-item">
      ...
      <legend>How long did it take you to land your FIRST JOB after or before graduation? :</legend>
<select class="custom-select" name="noJ_duration">
<option selected="">Open this select menu</option>
<option value="before graduation">before graduation</option>
<option value="less than a month after graduation">less than a month after graduation</option>
<option value="1 to 6 months">1 to 6 months</option>
<option value="7 to 1 year">7 to 1 year</option>
...
<input type="text" style="display: none;" name="Name_school" id="combine_name_school">
  ...
  <div class="row text-center">
      <div class="col"> <button class="btn btn-info w-100 btn-lg" style="padding: 10px;" data-target="#carouselExampleIndicators" data-slide-to="3">Previous</button></div>
       <div class="col"> <button class="btn btn-info w-100 btn-lg" style="padding: 10px;" data-target="#carouselExampleIndicators" data-slide-to="5">Submit</button>
      </div>
    </div>        
...
<script type="text/javascript">
  ...
  function reference_contact_num() {
